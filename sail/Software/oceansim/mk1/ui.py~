...
#Rudder_text = "AutoRudder"
#textObject = OnscreenText(text = Rudder_text, pos = (-1.1,0,.1), 
...
# Add button
Auto_Rudder = DirectCheckButton(text = "AutoRudder" ,scale=.05,pos = (-1.1,0,.05))
...
Auto_Sail = DirectCheckButton(text = "AutoSail" ,scale=.05,pos = (-1.1,0,-.55))
